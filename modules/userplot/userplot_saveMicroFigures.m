function userplot_saveMicroFigures(cav_dir,data_dir,num,results_dir,calc_times,pstep,S_coredata)
    ...
    %Load coeffs data
    S_EcoeffsData   = structdata_loadMicro(cav_dir,data_dir,num,'E','coeffs',calc_times,pstep);
    
    %Load field data
    S_EfieldData    = structdata_loadMicro(cav_dir,data_dir,num,'E','field',calc_times,pstep);
    
    %Load Davgabs data
    S_DavgabsData   = structdata_loadMicro(cav_dir,data_dir,num,'D','avgabs',calc_times,pstep);
    
    %Load Dcoeffs data
    S_DcoeffsData   = structdata_loadMicro(cav_dir,data_dir,num,'D','coeffs',calc_times,pstep);
